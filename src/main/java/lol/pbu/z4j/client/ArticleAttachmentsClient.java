...
public interface ArticleAttachmentsClient {
    ...
    HttpResponse<HttpResponse<@Valid ArticleAttachmentResponse>> createArticleAttachment(
    ...
    HttpResponse<HttpResponse<@Valid ArticleAttachmentResponse>> createAttachment();
    ...
    HttpResponse<HttpResponse<Void>> deleteArticleAttachment(
    ...
    HttpResponse<@Valid ArticleAttachmentsResponse> listArticleAttachments(
            @PathVariable("article_id") @NotNull Integer articleId
    );
    ...
    HttpResponse<@Valid ArticleAttachmentsResponse> listBlockArticleAttachments(
            @PathVariable("article_id") @NotNull Integer articleId
    );
    ...
    HttpResponse<@Valid ArticleAttachmentsResponse> listInlineArticleAttachments(
            @PathVariable("article_id") @NotNull Integer articleId
    );
    ...
    HttpResponse<@Valid ArticleAttachmentResponse> showArticleAttachment(
            @PathVariable("article_id") @NotNull Integer articleId,
            @PathVariable("article_attachment_id") @NotNull Integer articleAttachmentId
    );
}
